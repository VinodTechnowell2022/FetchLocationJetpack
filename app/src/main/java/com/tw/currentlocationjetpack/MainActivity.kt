package com.tw.currentlocationjetpack
...
import com.tw.currentlocationjetpack.ui.theme.CurrentLocationJetpackTheme
...
class MainActivity : ComponentActivity() {
     ...
     */
    @SuppressLint("MissingPermission")
    private fun getCurrentLocation(onGetCurrentLocationSuccess: (Pair<Double, Double>) -> Unit, onGetCurrentLocationFailed: (Exception) -> Unit,
        ...
        if (areLocationPermissionsGranted()) {
            ...
            fusedLocationProviderClient.getCurrentLocation(
                ...
                location?.let {
                    // If location is not null, invoke the success callback with latitude and longitude
                    Toast.makeText(this@MainActivity, "Location: ${it.latitude} ${it.longitude}", Toast.LENGTH_SHORT).show()
